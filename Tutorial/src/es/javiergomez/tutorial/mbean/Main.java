 ...
 * 
 * Open jconsole to manage MBean
 */
package es.javiergomez.tutorial.mbean;
...
public class Main {
	...
	ObjectName mbeanName = new ObjectName("es.javiergomez.tutorial.mbean:type=Hello");
	...
	mbs.registerMBean(mbean, mbeanName);
        ...
        ObjectName mxbeanName = new ObjectName("es.javiergomez.tutorial.mbean:type=QueueSampler");
